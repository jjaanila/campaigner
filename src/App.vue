<template>
  <main :style="{ background: `url(${require('./img/paper.jpg')}) repeat` }">
    <page>
      ...
      major road and river bypass the village so there is usually quite a bit of traffic. However, not many are willing
      to live this far away from major cities. Hunting and fishing are not that prolific professions either so the
      houses are modest and simply built log cabins. There are 11 smaller cabins and one larger, the White Rabbit Inn.
      One of the other smaller houses has wooden stands in front with fishes drying out in the morning sun. There is an
      old man repairing fishing nets on the porch. To north starts the road to the city of Sword, which follows the
      south bank of Fuller river. To the north is the road to the Gray Keep, Halla farm and the city of Brass Buckler.
      To the east is Hallasuo, huge marshland with just few inhabitants. To the west is river Viper's Rend (Kyynsärö).
      ...
      <read-aloud>
        ...
        seem to get much use. However, now there are four
        <id-link id="monster-soldier-of-the-sword" name="guards" type="monster" /> cleaning their boots and chatting. A
        fancy looking wagon stands next to the road and a young human man steps around anxiously. The man has fine
        clothing, brown long hair, and a sword on his hip.
      </read-aloud>
      <id-link name="Kaino Kalpa" type="monster" /> The man is Kaino Kalpa, a bastard of half-king Untamo Eteläterä. He
      is a proud man and doesn't appreciate that people remind him of his bastardiness. He thinks of himself as a prince
      and plans to travel to the court of Eteläterä to gain influence. He has been assigned to the Gray Keep since
      teenage and now that he has reached adulthood, it is his time. He has no time for mere peasants and want's to get
      moving as soon as possible. He plans to benefit from the unstable situation of the Blade and raise his ranks amid
      political chaos. He won't share his intent except if the party allies with him in the future. Kaino is able to
      tell the party about the turmoil in Sword cities. Two families descendants of the last Sword King are at each
      other's throats after Eteläterä's heir Armas Eteläterä fell to his dead from castle tower. The court of Eteläterä
      is suspicious of Pohjanterä. He doesn't mention that the Fuller river (Veriura) which flows between the two cities
      has changed color, tastes foul and reportedly causes sickness of children and weak of health. Pohjanterä court
      rumours that Eteläterä poisoned the water as revenge and the southern half-king has a secret source of clean water
      or a way to purify it. Secretly he thinks that the death of the heir is his chance to become the new heir.
      <id-link id="monster-commoner" name="Kala-Kosti" type="monster" /> An old man sitting on his porch repairing
      fishing nets. Can tell about refugees upriver that are coming from the Sword cities escaping restlessness. If
      asked, he tends to fish along the rivers because lake Iänlampi is not the best fishing spot. It actually doesn't
      have fish at all, but let's not reveal that yet.
      ...
      bandits in a camp up north. He got drinking with them and they needed his services to fix their equipment. Rautia
      and Tuomikki live in the village in their own house. Can tell about the wedding in Halla Farm. She requests the
      party to look for her lousy husband and promises to pay 20gp. <id-link name="Veli Hopea" type="monster" /> A human
      male with a bag full of tales. He has killed a werewolf, flirted with Tellervo, the daughter of Tapio, the god of
      forests. He also has been taught by shaman's of the north and has shared a meal with the half-king of the North
      Edge (Pohjanterän hovi). He is bragging about everything and is quite loud and tries actively to find new
      listeners. He want's to be viewed as a prosperous man, but the times have been rough. He was forced to flee the
      twin-cities of Sword because of his drunken babbles that offended one of the half-kings. An informant snitched and
      ...
      significantly during the nights making the environment even harsher for plants. Not many dare to venture there as
      tales tell that people go mad and drown themselves into swamp pools. People got lost and their clothes were found
      from the marshes. It is rumored that evil creatures inhabit the area nowadays. Tapio Halla or other family members
      can tell about these tales and rumours.
      <read-aloud>
        You arrive to a farmstead and see a lot of people sitting around a long table. All of them are wearing
        exceptionally clean and formal clothes and the place has been decorated with birch branches and flowers. This is
        a wedding of the man at the end of the long table, Antero Halla and his fiancee Vilja Halla. The man at the end
        of the table rises and the crowd goes silent. The man holds a tin bucket high and starts to sing: "Mehtolan
        metinen muori, Metän kultanen kuningas, Tule nyt häihin härköisiis, Pitkän villaisi pitoihin." He starts walking
        and others rise up and follow. Soon they form a line and move behind the lead singer.
      </read-aloud>
      If the party follows:
      <read-aloud>
        The crowd walks silently across the road and climbs all the way to top of a nearby hill. There the leader stops
        at a large gray ash tree. The tree is lush but barely the party sees some ornaments on its branches. The man
        lays down the container. He puts his hands inside and brings up a freshly cleaned bear skull, still dripping
        last drops of blood. He sings again: "En pistä sua pihlajaan, Enkä raitaan rakenna, Vaan honkaan hyvään puuhun,
        johon tuuli käypi pohjoisesta ja etelästä ja kaikilta tuulilta." Suddenly Vilja opens her mouth and sings with
        the same melody: "Tule, poikani polonen, Tuolla on ollut suuren suon sivulla, Ei oo tulta ei tulusta, Vara saaha
        valkijata" The man walks up to the tree and ties the fresh skull on the trunk. Suddenly the party realize that
        the ornaments are older skulls. Silently the crowd turns back and starts walking back to the farm.
      </read-aloud>
      ...
      denser forests with no visible paths. After few kilometers they meet a stranger, a tough looking dwarf woman next
      to a wagon, which leans heavily on its side. The woman
      ...
      encampment to trade fur and silver. Her mercenary guards left to get help back to the farm west yesterday morning
      but she hasn't seen them since. They should have arrived already. She proposes that the party helps her carry what
      ...
      <comment title="What kobolds and Jutikka know?">
        ...
        a searching but they were instructed "you will know when you find it". To hasten the search they have captured
        people to work for them. Jurva and Osmo Halla have been taken to the labor camp in the middle of the marsh.
      </comment>
      ...
      that shine faint light and drizzle down water. Down on the floor the water drops create a rain like effect. At the
      end of the hall is a large round pool with live vegetation around it, some stunted shrubs and grass that has only
      faintly green color. Otherwise the hall floor has only rubble where the ceiling has lost its strength during the
      centuries. With closer inspection and added lighting it can be seen that the paintings cover the walls of the
      hall. The ceiling is depiction of the night sky but the walls are still so dirty that the images cannot be
      inspected. At the pool sits metsäläinen <id-link name="Ahto Piki" type="monster" /> examining the vegetation. Two
      slaves are cleaning the pillars at the same end of the hall. One of them is Osmo Halla, Tapio Halla's nephew and
      ...
      <read-aloud>
        ...
        the ancestors were clever enough to try taking their secrets into their graves. Keep on looking, they must have
        missed something. May the trees shade your path.
      </read-aloud>
      After the fight, Osmo Halla reveals that his father was commanded to the marshes to show the abductors some other
      possibly interesting location in exchange for his son's freedom. He left his son behind because the journey is
      dangerous. Osmo has been cleaning the paintings for two days and hasn't eavesdropped anything significant. Osmo
      also knows the location his father spoke of. It is another structure few kilometers to north and almost completely
      submerged under water.
      <captioned-figure :path="ukkoMonastery" caption="Monastery of Ukko" width="30rem" />
      <area-title name="Hallasuo Cache" />
      The party should follow Osmo to Hallasuo Cache, which is a secret storage that Ukko worshippers left behind. There
      they will find 15 kobolds carrying supplies and tools, Jurva Halla and a tall elder bearded human male with black
      robes and a bird claw on his shirt. He is
      ...
      see them well. Jurva Halla stays still a numb look on his face, with eyes like glass. The party most likely waits
      to see what happens. After a few minutes the man starts to speak:
      <read-aloud>
      ...
      <id-link name="Golem Guardian" type="monster" /> shrieks and steps out attacking nearby kobolds crushing two with
      ...
      mussels. Terrain is rocky and barren and deep crevasses divide the shore to long platforms that reach to the sea.
      The keep was built by metsäläiset but after they were banished, kalevan fishermen made it their home. Catch was
      great so little by little they kept on spreading and extending their fortress. The keep is crudely built stony
      building but sometimes receives prestigious residents, although often royally disliked characters.
      <id-link name="Kaino Kalpa" type="monster" /> spent five years there managing the keep but leaving most of the
      accounting and decision making to his advisors. Sometimes he preferred to make arbitrary decisions about things he
      knew nothing about, just to feel himself important and needed. He has now left the keep to the relief of locals.
      ...
      fishermen keep going missing. Five boats have disappeared during four weeks and the scouts haven't found a sign of
      the boats. They have mostly searched further away from the shore so he suggests that the party should stay closer
      to the shoreline, especially if they don't have sailing experience. He also recommends talking to
      ...
      ex-fisherman Pulkkinen is a burly dwarf male with rugged worker hands and a face oldened by sea weather. He is not
      the most traditional commander but so isn't Gray Keep militia either. All have some kind of background in fishing
      so they understand Pulkkinen's peculiar commands, like "Sharpen your hooks!" to do equipment maintenance. He
      should also use all kinds of fishing expressions in his speech: "Have a reely good day.", "Seems a bit fishy to
      me.", "You've been schooled.". Pulkkinen tells the party that someone has been stealing their catch from "the
      tank". He explains that the tank is a large artificial pond they have created to keep the fish alive and fresh
      until they are sold to merchants. He suggests that the party investigates the tank. The issue was noticed
      yesterday when they conducted the first inspection of the tank in a long time. Earlier Kaino Kalpa had taken the
      solid responsibility of it without really doing his job. Pulkkinen doesn't trust Kaino and always suspected that
      there was something fishy about him. He spent most of his time dreaming about becoming the half-king. Kaino
      allowed metsäläiset to install the portal to the bottom for a promise that the would become the half-king one day.
      <sub-area-title name="The Tank" />
      A half ball shaped pond carved into the rocky shore. It is covered with a leathery cover that keeps the birds and
      other animals away. There are lids that can be opened to look inside. Hand nets with long shafts lie next to the
      lids. A member of <id-link name="Gray Keep Militia" type="monster" /> circles around the pond. The guard claims
      they have seen nothing unusual except the amount of fish has been reducing. On the bottom of the tank is a 2ft
      wide portal that leads to a cave river in a cave at the north end of the shoreline. The fish are able to escape
      ...
      Farming of barley is however the main source of income. Ukko's Fist is led by
      ...
      he is being forced to a decision. He received the ring as an anonymous gift.
      ...
      bedrooms for guests or house staff. On the top floor, there are the main bed room, a reading room and two more bed
      rooms for house staff. In the dungeon are few cells with just one prisoner witch Autere.
      ...
      DC 15 Perception check in one of the rooms when searching for a way into the dungeon.
      ...
      can be noticed with DC 10 perception check. The beard is just for the looks, it, in his words, is more convincing
      in seer work than his completely bald face. He has been hairless since born. He sits on his bed and demands to
      ...
      dug too deep and are likely killed by the beasts of the depths in
      ...
      feet on his shirt. The officer, <id-link id="monster-commoner" name="Kauko" type="monster" />, is quite
      ...
      other end is under South Edge castle tower and there is a secret hatch below the stairs. Knowledge of the tunnel
      is transferred from half-king to the next and its existence has to be kept secret from others. However, Hellä also
      knows about the tunnel because he spied his husband enter it one day. The tunnel played a major role in her affair
      with Armas as it made secret visits easy. Hellä also visited Armas just before his death through this tunnel,
      declared to him that he would never get her as his own and, with well selected words, drove him to suicide. She
      has a key to the room. She succeeded in her plan but made one mistake when she locked the door after her. She also
      took the painting of herself as she was afraid that it would raise suspicion.
      <sub-area-title name="Throne Room" /> A hall of stone that has wooden decorations with intricate carvings on stony
